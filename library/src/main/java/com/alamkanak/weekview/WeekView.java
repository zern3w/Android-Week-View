...
//        mTodayHeaderTextPaint.setTypeface(Typeface.DEFAULT_BOLD);
    ...
    private void drawHeaderRowAndEvents(Canvas canvas) {
        ...
        canvas.clipRect(0, 0, getWidth(), mHeaderHeight + mHeaderRowPadding * 2, Region.Op.REPLACE);
        ...
        for (int dayNumber=leftDaysWithGaps+1; dayNumber <= leftDaysWithGaps + mNumberOfVisibleDays + 1; dayNumber++) {
            ...
            canvas.drawText(dayLabel, (startPixel + mWidthPerDay / 2) - 70, mHeaderTextHeight + mHeaderRowPadding + 20, sameDay ? mTodayHeaderTextPaint : mHeaderTextPaint);
